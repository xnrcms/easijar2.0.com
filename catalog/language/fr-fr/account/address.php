...
$_['text_address_book']	= 'Entrées du carnet d’adresse';
$_['text_address_add']	= 'Ajouter une adresse';
$_['text_address_edit']	= 'Éditer une adresse';
$_['text_add']			= 'Votre adresse a été ajoutée avec succès !';
$_['text_edit']			= 'Votre adresse a été mise à jour avec succès !';
$_['text_delete']		= 'Votre adresse a été suprimée avec succès !';
$_['text_empty']		= 'Il n’y a aucune adresse dans votre compte.';
...
$_['error_default']		= 'Attention, vous ne pouvez pas supprimer l’adresse par défaut !';
