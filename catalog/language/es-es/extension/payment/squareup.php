...
$_['text_squareup_profile_suspended']   = ' Sus pagos recurrentes se han suspendido. Por favor, póngase en Contáctenos con nosotros para más detalles.';
...
$_['text_token_revoked_message']        = "El acceso de la extensión de pago Square a Mi cuenta se ha revocado en el panel de Square. Debe verificar las credenciales de la aplicación en la configuración de la extensión y volver a conectarse.";
$_['text_token_expired_subject']        = '¡Tu token de acceso ha caducado!';
$_['text_token_expired_message']        = "El token de acceso de la extensión de pago Square que lo conecta a Mi cuenta de Square ha expirado. Debe verificar las credenciales de la aplicación y el trabajo CRON en la configuración de la extensión y volver a conectarse.";
