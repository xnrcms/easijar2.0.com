<?php
// Text
$_['text_title']				= 'Cuenta Klarna - Pago de %s/mes';
...
$_['text_information']			= 'Klarna Información de la cuenta';
...
$_['text_month']				= 'Mes';
$_['text_day']					= 'Día';
$_['text_payment_option']		= 'Opciones pago';
$_['text_single_payment']		= 'Pago sencillo';
$_['text_monthly_payment']		= '%s - %s por mes';
$_['text_comment']				= 'Klarna\'s Factura ID: %s' . "\n" . '%s/%s: %.4f';

// Entry
$_['entry_gender']				= 'Gémero';
