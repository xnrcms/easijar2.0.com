...
$_['text_order_all']        = 'Все заказы';
$_['text_order_unpaid']     = 'неоплаченный';
$_['text_order_unshipped']  = 'неотправленный';
$_['text_order_shipped']    = 'Высылаем';
...
$_['button_complate']       = 'Подтвердите заказ';
$_['button_pay_continue']   = 'Оплатить';
$_['button_recharge']       = 'перезарядка';
$_['button_link_all']       = 'Больше';
$_['button_meiqia']         = 'Онлайн чат';
...
$_['error_no_template']     = '<div class="alert alert-warning">%s.twig отсутствует, отключите этот модуль на admin.</div>';
