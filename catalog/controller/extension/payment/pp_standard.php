...
class ControllerExtensionPaymentPPStandard extends Controller {
	public function index() {
		...
		if ($order_info) {
			...
			$data['first_name'] = html_entity_decode(array_get($order_info, 'payment_firstname'), ENT_QUOTES, 'UTF-8');
			$data['last_name'] = html_entity_decode(array_get($order_info, 'payment_lastname'), ENT_QUOTES, 'UTF-8');
			$data['fullname'] = html_entity_decode(array_get($order_info, 'payment_fullname'), ENT_QUOTES, 'UTF-8');
			...
			$data['invoice'] = $this->session->data['order_id'] . ' - ' . html_entity_decode(array_get($order_info, 'payment_fullname'), ENT_QUOTES, 'UTF-8');
