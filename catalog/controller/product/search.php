...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['status'])) {
			$stockStatusIds = parse_filters($this->request->get['status']);
		} else {
			$stockStatusIds = '';
		}
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			if (config('is_mobile')) {
				...
				$data['style_grid'] = $this->url->link('product/search', $url . '&style=grid');
				$data['style_list'] = $this->url->link('product/search', $url . '&style=list');
			}
