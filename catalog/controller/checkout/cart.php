        ...
        if ($product_info) {
            ...
            if ($flash_data) {
                if (!$flash_data['checkout']) {
                    $json['error']['flash_count'] = sprintf($this->language->get('error_flash_out'), $flash_data['count']);
                } else {
                    if ($flash_data && $flash_data['count'] && ($quantity + $cart_product_count) > $flash_data['count']) {
                        $json['error']['flash_count'] = sprintf($this->language->get('error_flash_count'), $flash_data['count']);
                    }
                }
            }
