...
class ModelExtensionPaymentAlipay extends Model {
	private $apiMethodNamePage = "alipay.trade.page.pay";
	private $apiMethodNameWap = "alipay.trade.wap.pay";
	...
	public function pageExecute($request, $httpmethod = "POST") {
		...
		$sysParams["method"] = config('is_mobile') ? $this->apiMethodNameWap : $this->apiMethodNamePage;
