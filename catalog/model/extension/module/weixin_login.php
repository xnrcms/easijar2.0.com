 ...
 */
class ModelExtensionModuleWeixinLogin extends ModelExtensionModuleSocial
{
    ...
    {
        if ($unionId) {
            $customer = $this->getCustomerByUnionId($unionId, 'weixin');
            if ($customer) {
                return $customer;
            }
            ...
            $customer = $this->getCustomerByUid($uid, 'weixin');
            return $customer;
        }
        return array();
    }
    ...
    {
        $social = $this->getSocialByProvider('weixin');
        //-------请求参数列表
        $keysArr = array(
