...
class ModelAccountCustomerFollowSeller extends Model {
	...
	public function getSellerFollowByCustomerId($seller_id) {
	...
	public function getSellerFollowBySellerId($seller_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_follow_seller WHERE seller_id = '" . (int)$seller_id . "'");
