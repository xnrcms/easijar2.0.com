...
class ModelAccountReturn extends Model {
	...
	public function getReturnForMs($return_id) {
		$fields 		= format_find_field('return_id,order_id,product_id,fullname,email,telephone,product,model,image,quantity,return_status_id,seller_id,comment,date_ordered,date_added,date_modified,return_reason_id,overtime,is_service,is_receive','r');
