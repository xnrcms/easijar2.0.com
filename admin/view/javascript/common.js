...
$(document).ready(function() {
    ...
    　});
      ...
      function updateColor(color, self) {
        console.log(color);
        ...
        $(self).val(hexColor);
        $(self)[0].dispatchEvent(new Event('input'));
      }
    }
	...
	$('#input-mail-engine').on('change', function () {
		if ($(this).val() == 'sendcloud') {
			$('#sendcloud-fields').show();
			$('#mail-fields').hide();
		} else {
			$('#sendcloud-fields').hide();
			$('#mail-fields').show();
		}
    });
    ...
    $(document).on('mouseover', 'a[data-toggle=\'image\']', function(e) {
