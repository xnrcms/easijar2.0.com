...
for (var index = 0; index < data.variants.length; index++) {
  var variants = data.variants[index], formattedVariants = data.selectedVariantsFormatted;
...
var app = new Vue({
  ...
  methods: {
    ...
    imageSrc: function (image) {
      return 'index.php?route=catalog/product/thumb&user_token=' + user_token + '&image=' + image;
    },
    ...
    saveProductButtonClicked: function () {
      ...
      showConfirm(i18n.text_confirm_save, i18n.button_save_changes, i18n.button_cancel, function () {
        ...
        $.ajax({
          url: 'index.php?route=catalog/product/variant_save&product_id=' + app.parentId + '&user_token=' + user_token,
          method: 'post',
          dataType: 'json',
          data: data,
          beforeSend: function () {
