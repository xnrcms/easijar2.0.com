...
// Heading
$_['heading_title']						= 'Annonce sur Amazon';
$_['text_title_advanced']				= 'Annonce avancée';
...
$_['button_remove_error']				= 'Retirez les messages d’erreur';
$_['button_save_upload']				= 'Enregistrer et télécharger';
...
$_['text_product_not_sent']				= 'Le produit n’a pas été envoyé à Amazon pour la raison suivante : %s';
$_['text_not_in_catalog']				= 'Ou, si il n’est pas dans le catalogue   ';
$_['text_placeholder_search']			= 'Entrer le nom du produit, UPC, EAN, ISBN ou ASIN';
$_['text_placeholder_condition']		= 'Utiliser cet emplacement pour décrire l’état de vos produits.';
$_['text_characters']					= 'caractères';
$_['text_uploaded']						= 'Annonce(s) enregistrée(s) téléchargée(s) !';
$_['text_saved_local']					= 'Annonce sauvegardée mais non téléchargée';
$_['text_product_sent']					= 'Le produit a été envoyé avec succès à Amazon.';
$_['text_links_removed']				= 'Liens des produits supprimés sur Amazon';
...
$_['entry_browse_node']					= 'Choisir le noeud de navigation';
...
$_['error_not_saved']					= 'L’annonce n’a pas été enregistré. Vérifiez que vous ayez rempli tous les champs';
$_['error_char_limit']					= 'caractères en plus de la limite';
$_['error_length']						= 'La longueur minimum est';
$_['error_upload_failed']				= 'Échec du téléchargement du produit avec SKU : "%s". Raison : "%s" Processus de téléchargement annulé.';
$_['error_load_nodes']					= 'Impossible de charger les nœuds de navigation';
$_['error_connecting']					= 'Il y a un problème de connexion à l’API. Veuillez vérifier vos paramètres d’extension Pro Amazon OpenBay. Si le problème persiste, veuillez contacter le support.';
$_['error_text_missing']				= 'Vous devez entrer quelques précisions pour la recherche';
...
$_['error_sending_products']			= 'Envoi impossible des produits pour l’inscription. Veuillez contacter le support';
$_['error_no_products_selected']		= 'Aucun produit n’a été sélectionné pour l’inscription';
$_['error_not_searched']				= 'Rechercher les articles assortis avant de vous essayer à la liste. Les articles doivent être comparés avec un produit du catalogue Amazon';