...
$_['text_success']					= 'Félicitations, vous avez modifié le module de paiement BluePay Redirect !';
$_['text_edit']						= 'Éditer le module de paiement BluePay Redirect (SSL requis)';
...
$_['text_release_ok_order']			= 'La mise à jour a été réalisée avec succès';
$_['text_rebate_ok']				= 'Le remboursement a été réalisé avec succès';
$_['text_rebate_ok_order']			= 'Le remboursement a été réalisé avec succès, l’état de la commande est passée à « remboursée »';
$_['text_void_ok']					= 'L’annulation a été réalisée avec succès, l’état de la commande est passée à « annulée »';
...
// Entry
$_['entry_vendor']					= 'Identification du compte';
...
$_['help_transaction']				= 'La méthode de transaction DOIT être réglé à paiement pour en permettre le versement';
$_['help_cron_job_token']			= 'Rendre ce terme long et difficile à deviner';
...
$_['error_account_id']				= 'L’identification de compte est requis !';
$_['error_secret_key']				= 'La clé secrète est requise !';