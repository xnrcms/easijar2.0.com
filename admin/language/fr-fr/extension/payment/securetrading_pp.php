...
$_['text_success']									= 'Félicitations, vous avez modifié le module de paiement Secure Trading avec succès !';
$_['text_pending_settlement']						= 'En attente du règlement';
$_['text_authorisation_reversed']					= 'L’annulation a été émis avec succès';
...
$_['entry_site_security_status']					= 'Utiliser le cryptage de sécurité du site';
$_['entry_site_security_password']					= 'Mot de passe de sécurité du site';
$_['entry_notification_password']					= 'Mot de passe de la notification';
$_['entry_order_status']							= 'État de la commande';
$_['entry_declined_order_status']					= 'État de la commande - refusé';
$_['entry_refunded_order_status']					= 'État de la commande - remboursé';
$_['entry_authorisation_reversed_order_status']		= 'État de la commande - annulée';
$_['entry_settle_status']							= 'État de la commande - réglé';
$_['entry_settle_due_date']							= 'Date de règlement';
$_['entry_geo_zone']								= 'Zone géographique';
$_['entry_sort_order']								= 'Classement';
$_['entry_status']									= 'État';
$_['entry_total']									= 'Total';
$_['entry_parent_css']								= 'Parent CSS';
$_['entry_child_css']								= 'Enfant CSS';
$_['entry_cards_accepted']							= 'Cartes acceptées';
$_['entry_reverse_authorisation']					= 'Autorisation annulation :';
$_['entry_refunded']								= 'Remboursé :';
$_['entry_refund']									= 'Émetteur remboursé (%s) :';

// Error
$_['error_permission']								= 'Vous n’avez pas la permission de modifier ce module';
$_['error_site_reference']							= 'La référence du site est requise';
$_['error_notification_password']					= 'Le mot de passe de notification est requis';
...
// Help
$_['help_username']									= 'Votre nom d’utilisateur au webservice';
$_['help_password']									= 'Votre mot de passe au webservice';
...
// Button
$_['button_reverse_authorisation']					= 'Autorisation d’annulation';
