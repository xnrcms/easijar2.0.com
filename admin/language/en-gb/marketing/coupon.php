...
$_['entry_customer_coupon']        = 'Customer';
...
$_['help_customer_group_coupon'] = 'Choose all customer group witch can use the coupon. Select no customer groups to apply coupon to all customer group.';
$_['help_customer_coupon']       = 'Choose all customer witch can use the coupon. Select no customers to apply coupon to all customer.';
