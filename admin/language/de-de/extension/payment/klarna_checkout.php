<?php
/**
 * @version		$Id: klarna_checkout.php 5287 2018-06-17 20:59:37Z mic $
...
$_['entry_colour_button']				= 'Button Hintergrundfarbe';
$_['entry_colour_button_text']			= 'Button Textfarbe';
$_['entry_colour_checkbox']				= 'Checkbox Hintergrundfarbe';
$_['entry_colour_checkbox_checkmark']	= 'Checkbox Hackenfarbe';
$_['entry_colour_header']				= 'KOpfzeile Textfarbe';
$_['entry_colour_link']					= 'Link Textfarbe';
$_['entry_separate_shipping_address']	= 'Erlaube eigene Versandadresse';
$_['entry_dob_mandatory']				= 'Geburtsdatum erforderlich (nur UK Stores)';
$_['entry_title_mandatory']				= 'Überschrift erforderlich (nur UK Stores)';
$_['entry_additional_text_box']			= 'Erlaube Newsletteranmeldung';

$_['entry_total']						= 'Gesamt';
$_['entry_order_status']				= 'Auftragsstatus';
$_['entry_order_status_authorised']		= 'Genehmigt';
$_['entry_order_status_part_captured']	= 'Tw. erfasst';
$_['entry_order_status_captured']		= 'Efasst';
$_['entry_order_status_cancelled']		= 'Storniert';
$_['entry_order_status_refund']			= 'Voll Rückerstattet';
$_['entry_order_status_fraud_rejected']	= 'Betrugsversuch - Abgewiesen';
$_['entry_order_status_fraud_pending']	= 'Betrugsversuch - warte auf Entscheidung';
$_['entry_order_status_fraud_accepted']	= 'Betrugsversuch - Angenommen';
...
$_['entry_shipping']					= 'Länder Versand';
$_['entry_api']							= 'API';
...
$_['help_separate_shipping_address']	= 'Wenn ja kann der Kunde verschiedene Rechnungs- und Versandadressen angeben';
$_['help_dob_mandatory']				= 'Wenn ja kann der Kunde Geburtsdatum nicht überspringen';
$_['help_title_mandatory']				= 'Wenn Nein wird Überschrift optional in Ländern welche eine benötigen';
$_['help_additional_text_box']			= 'ERlaubt eine Newsletteranmeldung innerhalb eine IFrames für angemeldete Kunden';
...
$_['help_shipping']						= 'Alle Länder innerhalb dieser Geozone sind verfügbar';
...
$_['error_tax_warning']					= 'Achtung: einige der Produkte verwenden eine Steurklasse basierend auf der Rechnungsadresse. Klarna kann diese nicht annehmen';
