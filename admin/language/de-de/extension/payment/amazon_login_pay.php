<?php
/**
 * @version		$Id: amazon_login_pay.php 5287 2018-06-17 20:59:37Z mic $
...
$_['text_amazon_login_pay']		= '<a href="https://pay.amazon.com/uk/sp/opencart" target="_blank" title="Konto eröffnen Amazon Pay"><img src="view/image/payment/amazonpay.png" alt="Anmelden und Bezahlen mit Amazon" title="Anmelden und Bezahlen mit Amazon" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_amazon_join']			= '<a href="https://pay.amazon.com/uk/sp/opencart" target="_blank" title=">Registrieren für Anmelden und Bezahlen mit Amazon"><u>>Registrieren für Anmelden und Bezahlen mit Amazon</u></a>';
...
$_['text_refund_ok']			= 'Rückzahlung erfolgreich angefordert';
$_['text_refund_ok_order']		= 'Rückzahlung erfolgreich angefordert, Betrag vollständig retourniert';
...
$_['text_minimum_total']		= 'Warenkorb Mindestgesamtbetrag';
$_['text_geo_zone']				= 'Geozone';
$_['text_status']				= 'Status';
$_['text_declined_codes']		= 'Ablehnungscodes';
...
$_['text_amazon_no_declined']	= '-- Keine autom. Absage --';
$_['text_amazon_signup']		= 'Anmelden zu Anmelden &amp; Bezahlen mit Amazon';
$_['text_credentials']			= 'Hier die Schlüssel einfügen (JSON Format)';
$_['text_validate_credentials']	= 'Genehmigungs- &amp; Verwendungsangaben</button><button style="margin-top: 15px;" class="btn btn-warning" onclick="window.open(\'https://pay.amazon.com/us/help/201828830\', \'_blank\', \'\'); return false;">Hinweis: zum Anzeigen der Module <b>Bezahlen / Anmelden</b><br />muss im Menü <b>Design > Layouts</b> (z.B. Checkout &amp; Konto)<br />eine Position definiert werden.<br />Zur Einbauanleitung hier klicken';
...
// Help
$_['help_pay_mode']				= 'Zahlung nur für amerikanischen Markt möglich';
$_['help_checkout']				= 'Anmelden = Zahlungsbutton meldet gleichzeitig Kunde an.<br />Existiert Kunde noch nicht, wird er automatisch neu angelegt';
$_['help_capture_status']		= 'Auftragsstatus auswählen welcher eine automatische Übernahme einer genehmigten Zahlung auslöst';
...
$_['help_declined_codes']		= 'Ablehnungscodes';
...
$_['error_pay_mode']			= 'Zahlung ist nur für amerikanischen Markt möglich';
...
$_['error_credentials']			= 'Schlüssel muss in gültigem JSON-Format angegeben werden';
