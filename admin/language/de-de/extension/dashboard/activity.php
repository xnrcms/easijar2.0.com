<?php
/**
 * @version		$Id: activity.php 5287 2018-06-17 20:59:37Z mic $
...
$_['text_activity_return_account']	= '<a href="customer_id=%d">%s</a> reichte <a href="return_id=%d">Produktretoure</a> ein';
$_['text_activity_return_guest']	= '%s reichte <a href="return_id=%d">Produktretoure</a> an';
$_['text_activity_order_account']	= '<a href="customer_id=%d">%s</a> erstellte <a href="order_id=%d">neuen Auftrag</a>';
$_['text_activity_order_guest']		= '%s erstellte <a href="order_id=%d">neuen Auftrag</a>.';
$_['text_activity_affiliate_add']	= '<a href="customer_id=%d">%s</a> registrierte sich als Partner';
$_['text_activity_affiliate_edit']	= '<a href="customer_id=%d">%s</a> aktualisierte Partnerdetails';
