...
class ControllerCommonColumnLeft extends Controller {
    public function index() {
        if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ((string)$this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/variant')) {
                $catalog[] = array(
                    'name'     => $this->language->get('text_variant'),
                    'href'     => $this->url->link('catalog/variant', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/askquestion')) {
                $catalog[] = array(
                    'name'     => $this->language->get('text_consulting'),
                    'href'     => $this->url->link('catalog/askquestion', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'catalog/review')) {
                $catalog[] = array(
                    ...
                    'href'     => $this->url->link('catalog/oreview', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'blog/category')) {
                $blog[] = array(
                    ...
                    'href'     => $this->url->link('blog/category', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'blog/post')) {
                $blog[] = array(
                    ...
                    'href'     => $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'blog/setting')) {
                $blog[] = array(
                    ...
                    'href'     => $this->url->link('blog/setting', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'faq/category')) {
                $faq[] = array(
                    'name'     => $this->language->get('text_faq_category'),
                    'href'     => $this->url->link('faq/category', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'faq/faq')) {
                $faq[] = array(
                    'name'     => $this->language->get('text_faq'),
                    'href'     => $this->url->link('faq/faq', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            $seo = [];
            if ($this->user->hasPermission('access', 'design/seo_url_setting')) {
                $seo[] = array(
                    'name'     => $this->language->get('text_seo_url_setting'),
                    'href'     => $this->url->link('design/seo_url_setting', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'sale/withdraw')) {
                $sale[] = array(
                    'name'     => $this->language->get('text_withdraw'),
                    'href'     => $this->url->link('sale/withdraw', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'marketing/coupon2')) {
                $marketing[] = array(
                    'name'     => $this->language->get('text_coupon2'),
                    'href'     => $this->url->link('marketing/coupon2', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'localisation/pickup')) {
                $localisation[] = array(
                    'name'     => $this->language->get('text_pickup'),
                    'href'     => $this->url->link('localisation/pickup', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'tool/gd_export_import')) {
                $maintenance[] = array(
            ...
            if ($this->user->hasPermission('access', 'tool/tracking_import')) {
                $maintenance[] = array(
                    'name'     => $this->language->get('text_tracking_import'),
            ...
            if ($this->user->hasPermission('access', 'tool/action_log')) {
                $maintenance[] = array(
                    'name'     => $this->language->get('text_action_log'),
                    'href'     => $this->url->link('tool/action_log', 'user_token=' . $this->session->data['user_token']),
                    'children' => array()
                );
            }
            ...
            $data['menus'][] = [
                ...
                'icon'     => 'fa-apple',
                'name'     => t('text_app_cp'),
                'href'     => $this->url->link('app/setting'),
                'children' => null
            ];
            ...
            $data['menus'][] = [
                'id'       => 'menu-miniapp-cp',
                'icon'     => 'fa-wechat',
                'name'     => t('text_miniapp_cp'),
                'href'     => $this->url->link('miniapp/setting'),
                'children' => null
            ];
