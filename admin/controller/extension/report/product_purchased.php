...
class ControllerExtensionReportProductPurchased extends Controller {
	...
	public function report() {
        ...
        if (isset($this->request->get['export']) && ($this->request->get['export']==="export")) {
            $this->response->downloadCsv("product_purchased.csv", $header, $expOrders);
            exit();
        }
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . $this->session->data['user_token'] . '&code=product_purchased' . $url . '&page={page}');
