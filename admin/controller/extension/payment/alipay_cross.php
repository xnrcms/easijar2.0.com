...
class ControllerExtensionPaymentAlipayCross extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/alipay_cross', 'user_token=' . $this->session->data['user_token'])
		);

		$data['action'] = $this->url->link('extension/payment/alipay_cross', 'user_token=' . $this->session->data['user_token']);
        ...
        if (isset($this->request->post['payment_alipay_cross_log'])) {
            $data['payment_alipay_cross_log'] = $this->request->post['payment_alipay_cross_log'];
        } else {
            $data['payment_alipay_cross_log'] = $this->config->get('payment_alipay_cross_log');
        }
