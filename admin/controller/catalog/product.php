...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getList() {
        ...
        $data['permission_modify'] = $this->user->hasPermission('modify', 'catalog/product');
        ...
        $data['filter_stock_quantity'] = $filter_stock_quantity;
        ...
        if ($this->request->post['product_seo_url']) {
            ...
            foreach ($this->request->post['product_seo_url'] as $store_id => $language) {
                foreach ($language as $language_id => $keyword) {
                    ...
                    if (isset($this->request->get['product_id'])) {
                        $exclude_query = 'product_id=' . $this->request->get['product_id'];
                    } else {
                        $exclude_query = '';
                    }
                    $available = $this->model_design_seo_url->isAvailable($keyword, $language_id, $store_id, $exclude_query);
                    if (!$available) {
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])
            ...
            foreach ($results as $result) {
                ...
                if ($variantData = Models\Product::find($result['product_id'])->getVariantLabels('string')) {
                    $result['name'] .= " ({$variantData})";
                }
    ...
    public function get_names() {
        ...
        $product_id = (int)$this->request->get['product_id'];
        $this->load->model('catalog/product');
        $results = $this->model_catalog_product->getProductDescriptions($product_id);

        if (!$results) {
            $json['status'] = 0;
            $json['message'] = t('error_product_not_found');
            $json['data'] = null;
    ...
    public function edit_names() {
        ...
        if ($this->request->server['REQUEST_METHOD'] != 'POST') {
            $json['status'] = 0;
            $json['message'] = 'Request method not allowed.';
            $json['data'] = null;
        ...
        if (!array_get($this->request->post, 'name')) {
            $json['status'] = 0;
            $json['message'] = t('error_name');
            $json['data'] = null;
        ...
        $this->load->model('catalog/product');
        $this->model_catalog_product->editProductNames($product_id, $names);

        $json['status'] = 1;
        $json['message'] = t('text_success');
        $json['data'] = $names[current_language_id()];
        $this->jsonOutput($json);
    }
    ...
    public function edit_model() {
        ...
        if (!array_get($this->request->post, 'model') || trim($this->request->post['model']) == '') {
            $json['status'] = 0;
            $json['message'] = t('error_model_required');
            $json['data'] = null;
        ...
        $this->load->model('catalog/product');
        $this->model_catalog_product->editProductModel($product_id, $model);
    ...
    public function edit_quantity() {
        ...
        if (array_get($this->request->post, 'quantity') === null) {
            $json['status'] = 0;
            $json['message'] = t('error_quantity_required');
            $json['data'] = null;
        ...
        $this->load->model('catalog/product');
        $this->model_catalog_product->editProductQuantity($product_id, $quantity);
    ...
    public function edit_price() {
        ...
        $product_id = (int)array_get($this->request->get, 'product_id');
        if ($product_id < 1) {
            $json['status'] = 0;
            $json['message'] = t('error_product_id_required');
            $json['data'] = null;
        ...
        $price = (float)array_get($this->request->post, 'price');
        if ($price === null) {
            $json['status'] = 0;
            $json['message'] = t('error_price_required');
            $json['data'] = null;
        ...
        if ($price < 0) {
            $json['status'] = 0;
            $json['message'] = t('error_number_quantity');
            $json['data'] = null;
        ...
        $this->load->model('catalog/product');
        $this->model_catalog_product->editProductPrice($product_id, $price);

        $json['status'] = 1;
        $json['message'] = t('text_success');
        $json['data'] = $this->currency->format($price, $this->config->get('config_currency'));
    ...
    public function updatePrice()
    {
        ...
        if ($type == 'reset') {
            ...
            model('catalog/product')->batchUpdateProductPrice($data);
        }
        ...
        $json['link'] = html_entity_decode($this->url->link('catalog/product', $url));
        $this->jsonOutput($json);
    }
    ...
    public function updateQuantity()
    {
        ...
        if ($type == 'reset') {
            ...
            model('catalog/product')->batchUpdateProductQuantity($data);
        }
    ...
    public function updateStatus()
    {
        ...
        $this->load->language('catalog/product');
        $productIds = $this->request->post['product_id'];
        model('catalog/product')->batchUpdateProductStatus($productIds);
    ...
    public function variant()
    {
        ...
        $this->response->setOutput($this->load->view('catalog/product_variant', $data));
    }
