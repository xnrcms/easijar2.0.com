...
class ControllerDesignLayout extends Controller {
	private $error = array();
	protected $mobile = false; // 是否设置手机端布局模块

	public function __construct($registry)
	{
	    parent::__construct($registry);
	    $this->mobile = (array_get($this->request->get, 'type') == 'mobile');
	}
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_design_layout->addLayout($this->request->post, $this->mobile);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_design_layout->editLayout($this->request->get['layout_id'], $this->request->post, $this->mobile);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['layout_id'])) {
			...
			$data['action'] = $this->url->link('design/layout/edit', 'user_token=' . $this->session->data['user_token'] . '&layout_id=' . $this->request->get['layout_id'] . $url . ($this->mobile ? '&type=mobile' : ''));
		}
		...
		if (isset($this->request->post['layout_module'])) {
			...
			$layout_modules = $this->model_design_layout->getLayoutModules($this->request->get['layout_id'], $this->mobile);
		} else {
