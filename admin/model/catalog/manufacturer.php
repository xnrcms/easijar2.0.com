		...
		if (isset($data['manufacturer_seo_url'])) {
			...
			foreach ($data['manufacturer_seo_url'] as $store_id => $language) {
				foreach ($language as $language_id => $keyword) {
					if (empty($keyword) && (boolean)config('seo_url_setting_manufacturer_status')) {
						$keyword = $this->model_design_seo_url->createUniqueKeyword($data['name'], $language_id, $store_id, 'manufacturer', $manufacturer_id);
					}
