...
class ModelCustomerCustomer extends Model {
	...
	public function getCustomers($data = array()) {
        ...
        if (!empty($data['filter_customer'])) {
            $sql .= " AND (c.fullname LIKE '%" . $this->db->escape($data['filter_customer']) . "%' OR c.email LIKE '%" . $this->db->escape($data['filter_customer']) . "%' OR c.telephone LIKE '%" . $this->db->escape($data['filter_customer']) . "%' OR c.customer_id LIKE '%" . $this->db->escape($data['filter_customer']) . "%')";
        }
		...
		if (!empty($data['filter_telephone'])) {
			$sql .= " AND c.telephone LIKE '%" . $this->db->escape((string)$data['filter_telephone']) . "%'";
		}
...
//            $cityId = $this->model_localisation_city->getCityIdFromAddress($address_query->row);
	...
	public function getTotalCustomers($data = array()) {
		...
		if (!empty($data['filter_telephone'])) {
			$implode[] = "telephone LIKE '%" . $this->db->escape((string)$data['filter_telephone']) . "%'";
		}
