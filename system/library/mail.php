...
class Mail
{
    ...
    public function __construct($adaptor = '')
    {
        ...
        $this->adaptorText = studly_case($adaptor);
        $class = 'Mail\\' . $adaptor;
    ...
    private function setParams()
    {
        ...
        $this->smtp_hostname = $config->get('config_mail_smtp_hostname');
        $this->smtp_username = $config->get('config_mail_smtp_username');
        $this->smtp_password = html_entity_decode($config->get('config_mail_smtp_password'), ENT_QUOTES, 'UTF-8');
        $this->smtp_port = $config->get('config_mail_smtp_port');
        $this->smtp_timeout = $config->get('config_mail_smtp_timeout');
