...
class Image {
	...
	public function __construct($file) {
        ...
        $temp_file = str_replace(DIR_IMAGE, '', $file);
        if($temp_file == 'placeholder.png' || $temp_file == 'no_image.png') {
            if(is_file(DIR_IMAGE . 'placeholder/' . $temp_file)) {
                $file = DIR_IMAGE . 'placeholder/' . $temp_file;
            }
        }
		if (file_exists($file)) {
			$this->file = $file;
