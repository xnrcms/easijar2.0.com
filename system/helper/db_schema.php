...
function db_schema() {
	...
	$tables[] = array(
		'name' => 'order_product_review_image',
		'field' => array(
			array(
				'name' => 'order_product_review_image_id',
				'type' => 'int(11)',
				'not_null' => true,
				'auto_increment' => true
			),
    ...
    $tables[] = array(
        ...
        'field' => array(
            ...
            array(
                'name' => 'product_question_helpfull',
                'type' => 'int(11)',
                'not_null' => true
            ),
            array(
                'name' => 'product_question_nothelpfull',
                'type' => 'int(11)',
                'not_null' => true
            ),
            array(
                'name' => 'question_asked_date',
                'type' => 'datetime',
                'not_null' => true
            ),
            array(
                'name' => 'question_answred_date',
                'type' => 'datetime',
                'not_null' => true
            )
        ),
	...
	$tables[] = array(
		'name' => 'variant_value_description',
		'field' => array(
			array(
				'name' => 'variant_value_id',
				'type' => 'int(11)',
